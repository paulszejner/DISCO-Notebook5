...
The first part of this exercise relies upon high temporal-intra annual resolution measurements of O isotopes for one year/growing season (1998) from a tree located in US SW (HEL Site) and is based on concepts reviewed in tree ring formation (Xylogenesis), sampling design and strategy, and seasonal coupling of climate and ecophysiology.  

The Second part of this exercise relies upon seasonal resolution  (earlywood and latewood) measurements of C and O for the XX period from multiple trees located in US SW (X Site). In this part, you will explore seasonal differences in C and O absolute values, their correlations to seasonal climate and their interpretation in terms of sesonal ecophysiological responses
...
The Year 1998 was sampled at X microns for a total of X thin sections and O measurements
```{r}
